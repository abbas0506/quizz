   ...
   <div class="flex-container-centered h-70 p-4">
      <div class="w-70 auto-expand">
         ...
         <div class="text-right p-2">
            <div id='finish' class='txt-10'>After adding all levels, click on finsh button <button class="btn btn-danger btn-sm" onclick="window.location.href='#'">Finish</button></div>
         </div>
