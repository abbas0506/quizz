<div class="sidebar">
    ...
    <a href="{{route('mysubjects.index')}}" class='hyper'><div class="menu-item" ><div class="icon"><i class="flaticon-open-magazine"></i></div><div class="icon-desc">Subjects</div></div></a>
